...
driver = webdriver.Chrome(
    executable_path=r"C:/Users/Dave/Webdrivers/chromedriver.exe")
time.sleep(2)
...
# search[0].send_keys(contact+Keys.ENTER) #type the contact name in this string
# time.sleep(2)
...
# this string contains the path of the file to be uploaded
dialog.send_keys(r"C:/Users/Dave/Python/Python Scripts/Halo/MVP.xlsx")
...
# msg_box = driver.find_element_by_class_name(r'DuUXI')
