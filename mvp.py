...
while True:
    if who_played[0].lower() == 'y':
        players = ('budbudhardy', 'flaresman', 'sashwank',
                   'Dead1n5ide', 'ManChivster', 'RustlingSpore', 'Fro5tShark')
        break
    if who_played[0].lower() == 'y' and s_matt[0].lower() == 'y':
        players = ('budbudhardy', 'flaresman', 'sashwank', 'Dead1n5ide',
                   'ManChivster', 'RustlingSpore', 'Fro5tShark', 'UBERmatto')
        break
    if who_played[0].lower() == 'y' and gary[0].lower() == 'y':
        players = ('budbudhardy', 'flaresman', 'sashwank', 'Dead1n5ide',
                   'ManChivster', 'RustlingSpore', 'Fro5tShark', 'r3dFlash')
        break
